...
from .whois_tools import do_whois

app = typer.Typer(add_completion=False, help="Cybersecurity Toolkit CLI")
console = Console()
...
def version_cmd() -> None:  # pragma: no cover - trivial
    """Print version to verify CLI wiring."""
    console.print(md.version("cybersecurity-toolkit"))
